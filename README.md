...
- Timestamp: `2022-06-07 11:55`
- Build ID: `34b1cb08-4655-49a1-b6a2-36f51dc6e1e2`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/34b1cb08-4655-49a1-b6a2-36f51dc6e1e2.git
$ cd 34b1cb08-4655-49a1-b6a2-36f51dc6e1e2
```
